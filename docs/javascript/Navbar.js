        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center w-full md:p-5 p-3 md:h-24 h-20">
            ...
            <div class="md:flex items-center gap-10 hidden">
                <ul data-aos="fade-left" class="md:flex hidden items-center gap-7">
                    <li><a href="./index.html" class="hover:text-[#3da1b9] transition-all duration-500">Home </a>
                    </li>
                    <li><a href="#about" class="hover:text-[#3da1b9] transition-all duration-500">About
                        </a>
                    </li>
                    <li><a href="#services" class="hover:text-[#3da1b9] transition-all duration-500">Services
                        </a>
                    </li>
                    <li><a href="#team" class="hover:text-[#3da1b9] transition-all duration-500">Team </a>
                    </li>
        ...
        <div class="p-6">
            <ul class="flex relative z-50 flex-col gap-7">
                <li><a href="./index.html"
                        class="hover:text-[#3da1b9] mobileMenuCloseBtn text-nowrap transition-all duration-500">Home</a>
                </li>
                <li><a href="#about"
                        class="hover:text-[#3da1b9] mobileMenuCloseBtn text-nowrap transition-all duration-500">About</a>
                </li>
                <li><a href="#services"
                        class="hover:text-[#3da1b9] mobileMenuCloseBtn text-nowrap transition-all duration-500">Services</a>
                </li>
                <li><a href="#team"
                        class="hover:text-[#3da1b9] mobileMenuCloseBtn text-nowrap transition-all duration-500">Team</a>
                </li>
                <li><a href="#testimonials"
                        class="hover:text-[#3da1b9] mobileMenuCloseBtn text-nowrap transition-all duration-500">Testimonials</a>
                </li>
                <li><a href="#howitwork"
            ...
            <a href="#contact"
                class="text-center block mobileMenuCloseBtn w-full p-3 border text-nowrap border-zinc-700 mt-5 rounded-lg cursor-pointer">Contact
                us</a>
        </div>
    </div>
